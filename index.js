...
client.on('messageCreate', (message) => {
    if (message.content === '!setup') {
        ...
        .setTitle('التقديم على الادارة')
        .setDescription('**أضـغـط على  (📝)  لبدا التقديم**')
        .setImage("https://media.discordapp.net/attachments/1073648099530121306/1076041235753607228/PicsArt_02-17-10.22.09.jpg")
